<link rel="stylesheet" href="${url}/css/travelView.css" type="text/css" />
...
<script type="text/javascript" src="/js/travel_information/t_map.js"></script>
	...
	$(document).on("click", "#btn_enter",function(event){
		...
		$.ajax({
			...
			data : {
				...
				$("#comment").val("");
				alert(result.msg);
				window.location.href="${url}/travel_information/"+contentid;
